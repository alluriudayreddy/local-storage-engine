...
def update_record(record_list, record_id, new_name, new_price, new_quantity, new_category, new_brand, new_status):
    for record_item in record_list:
        if record_item["id"] == record_id:
            record_item["name"] = new_name
            record_item["price"] = new_price
            record_item["quantity"] = new_quantity
            record_item["category"] = new_category
            record_item["brand"] = new_brand
...
def create_new_record(record_id, name, price, quantity, category, brand, status):
    record_item = create_record(record_id, name, price, quantity, category, brand, status)
...
def edit_record(record_id, new_name, new_price, new_quantity, new_category, new_brand, new_status):
